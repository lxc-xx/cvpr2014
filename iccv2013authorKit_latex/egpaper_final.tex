...
By submitting a manuscript to ICCV the authors guarantee that it has 
...
ICCV 2013 review period to {\bf any of the following}: another conference,
a workshop, or a journal. The authors also attest that they did not submit
substantially similar submissions to ICCV 2013. {\bf Violation of any of
...
(2)~argue in the body of your paper why your ICCV paper is non-trivially
different from these concurrent submissions, and (3)~include anonymized
versions of those papers in the supplemental material.

\subsection{Paper length}
ICCV papers may be up to 8 pages, with a flat \$200 fee for each paper published.  
Unlike in previous years, there is no discount for a 6 page paper.  
