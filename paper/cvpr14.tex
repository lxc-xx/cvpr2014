...
outperform other
methods on a number of challenging datasets~\cite{Wang12}. A modern extension of \cite{Wang12} uses motion stabilization and removal of human-related trajectories~\cite{Wang13}.
...
Out method is fast and enables accurate action recognition using linear classifiers.
