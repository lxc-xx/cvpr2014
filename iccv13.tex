...
\title{\mbox{}\vspace{-1cm}\\Towards efficient feature extraction, encoding and classification\\ for action recognition\vspace{-.2cm}\\}
...
\end{tabular}
\mbox{}\vspace{.1cm}\\
\caption{{\bf Left:} Evaluation of action classification accuracy and the speed of feature computation for Hollywood2 action recognition benchmark. The speed of feature computation is reported for video of spatial resolution $640\times480$ evaluated on a single core Intel Xeon E5345 2.33 GHz processor.
...
CD MBH FV(32)		& 45.4\% 	& 455.6                    & 268.0 	& 168.7	\\ % FPS = 410 / 0.9 = 455.5556, 410 / 3.16 = 129.7468, 1 / (1/455.5556 + 1/267.9739) =   101.0; 410 / 1.53 = 267.9739, 1 / (1/455.5556 + 1/267.9739) =   168.7243
\hline
