...
%Russian elections that has generated over 100 years of video just in one
...
In this work we use Fisher Vector encoding and linear SVM 
providing efficient action classification.
